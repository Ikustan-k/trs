...
public class CheckPoint3 extends Activity
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    startActivityForResult(
                            ...
                            CheckPoint3.REQUEST_AUTHORIZATION);
                } else {
        ...
        private void putDataFromApi() throws IOException {
            ...
            String range = ("F"+num_final+":G"+num_final);
            ValueRange valueRange = new ValueRange();
            List row = new ArrayList<>();
            List col = Arrays.asList(c3_gen_data,date.toString());
            row.add(col);
