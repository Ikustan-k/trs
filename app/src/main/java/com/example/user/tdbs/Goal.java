...
public class Goal extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //videoView.setVideoPath(path+"/TRS/video1.mp4");
        videoView.start();
    ...
    private void goal_video(){
        TextView res_tex2 =(TextView)findViewById(R.id.textView2);
        final VideoView videoView = (VideoView) findViewById(R.id.video);
        if(res_out0 != null){
            videoView.stopPlayback();
            res_vid_num = res_out1+res_out2+res_out3;
            if(res_vid_num != "000") {
    ...
    private void addIDdata(){
        TextView res_tex2 =(TextView)findViewById(R.id.textView2);
        res_tex2.setText("入力確定 " + " >>>  ID:"+num_final);
    }
    ...
    private void setNextVideo()
    {
        ...
        //videoView.setVideoURI(Uri.parse("android.resource://" + this.getPackageName() + "/" +R.raw.video1));
        //videoView.setVideoURI(Uri.parse("android.resource://com.example.user.tdbs/raw/video1"));
        videoView.setVideoPath("/storage/emulated/0/TRS/video1.mp4");
        videoView.start();
    }
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        private List<String> getDataFromApi() throws IOException {
            ...
            String spreadsheetId = "1vD25fNG2pPmNAV0IIFc-7pwzMU44-tx_C7JFFeS2Vtk";
        ...
        private void putDataFromApi() throws IOException {
            ...
            String range = ("J"+num_final+":K"+num_final);
            ValueRange valueRange = new ValueRange();
            List row = new ArrayList<>();
            List col = Arrays.asList("GOAL",date.toString());
            row.add(col);
